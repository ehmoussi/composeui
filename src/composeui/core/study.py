...
def open_file_without_update(*, main_view: IMainView, model: AnyModel) -> None:
...
def clear(main_view: IMainView, model: AnyModel) -> None:
    r"""Clear datas."""
    model.new()
    tools.update_all_views(main_view)


def ask_confirmation(main_view: IMainView, action: str) -> bool:
