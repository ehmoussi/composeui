...
@dataclass(eq=False)
class RowItemView(View, IRowItemView[AnyFormItems]):
...
@dataclass(eq=False)
class NoLabelView(RowItemView[AnyFormItems], INoLabelView[AnyFormItems]): ...


@dataclass(eq=False)
class LabelView(RowItemView[AnyFormItems], ILabelView[AnyFormItems]):
...
@dataclass(eq=False)
class CheckBoxView(RowItemView[AnyFormItems], ICheckBoxView[AnyFormItems]):
...
@dataclass(eq=False)
class _EditView(RowItemView[AnyFormItems], IEditView[AnyFormItems]):
...
@dataclass(eq=False)
class LineEditView(_EditView[AnyFormItems], ILineEditView[AnyFormItems]):
...
@dataclass(eq=False)
class TextEditView(RowItemView[AnyFormItems], ITextEditView[AnyFormItems]):
...
@dataclass(eq=False)
class DoubleLineEditView(_EditView[AnyFormItems], IDoubleLineEditView[AnyFormItems]):
...
@dataclass(eq=False)
class Vector3DView(RowItemView[AnyFormItems], IVector3DView[AnyFormItems]):
...
@dataclass(eq=False)
class SpinBoxView(RowItemView[AnyFormItems], ISpinBoxView[AnyFormItems]):
...
@dataclass(eq=False)
class ComboBoxView(RowItemView[AnyFormItems], IComboBoxView[AnyFormItems]):
...
@dataclass(eq=False)
class ComboBoxItemsView(RowItemView[AnyFormItems], IComboBoxItemsView[AnyFormItems]):
...
@dataclass(eq=False)
class ButtonsGroupView(RowItemView[AnyFormItems], IButtonsGroupView[AnyFormItems]):
...
@dataclass(eq=False)
class SelectFileView(RowItemView[AnyFormItems], ISelectFileView[AnyFormItems]):
    view: QWidget = field(init=False, default_factory=QWidget)
...
class RowView(IRowView[AnyFormItems]):
    label_view: RowItemView[AnyFormItems] = field(repr=False)
    field_view: RowItemView[AnyFormItems] = field(repr=False)


@dataclass(eq=False)
class FormView(View, IFormView[AnyFormItems]):
    ...
    def add_row(self, row_view: RowView[AnyFormItems]) -> None:
    ...
    def add_form(self, form_view: "FormView[AnyFormItems]") -> None:
    ...
    def _add_rows(self) -> None:
        for row_field in fields(self):
            ...
            form_view: Union[ApplyFormView[AnyFormItems], FormView[AnyFormItems]]
            if isinstance(irow_view, IRowView):
                ...
                if label_view is not None and field_view is not None:
                    row_view = RowView(label_view, field_view)
    ...
    def _make_form(self, iview: IFormView[AnyFormItems]) -> "FormView[AnyFormItems]":
        ...
        if isinstance(iview, IGroupBoxFormView):
            bases = (GroupBoxFormView[AnyFormItems],)
        else:
            bases = (FormView[AnyFormItems],)
        bases += (iview_type,)
        form_view_type: Type[FormView[AnyFormItems]] = make_dataclass(
            cls_name,
            fields=(),
            bases=bases,
            eq=False,
    ...
    ) -> "ApplyFormView[AnyFormItems]":
        """Make an apply form view from the given interface."""
        iview_type = type(iview)
        cls_name = iview_type.__name__[1:]
        bases: Tuple[Any, ...]
        if isinstance(iview, IGroupBoxApplyFormView):
            bases = (GroupBoxApplyFormView[AnyFormItems],)
        else:
            bases = (ApplyFormView[AnyFormItems],)
        bases += (iview_type,)
        form_view_type: Type[ApplyFormView[AnyFormItems]] = make_dataclass(
            cls_name,
            fields=(),
            bases=bases,
            eq=False,
    ...
    ) -> Optional[RowItemView[AnyFormItems]]:
        if isinstance(iview, INoLabelView):
            return NoLabelView[AnyFormItems]()
        elif isinstance(iview, ILabelView):
            return LabelView[AnyFormItems]()
        elif isinstance(iview, ICheckBoxView):
            return CheckBoxView[AnyFormItems]()
        elif isinstance(iview, ISelectFileView):
            return SelectFileView[AnyFormItems]()
        elif isinstance(iview, IDoubleLineEditView):
            return DoubleLineEditView[AnyFormItems]()
        elif isinstance(iview, IVector3DView):
            return Vector3DView[AnyFormItems]()
        elif isinstance(iview, ILineEditView):
            return LineEditView[AnyFormItems]()
        elif isinstance(iview, ITextEditView):
            return TextEditView[AnyFormItems]()
        elif isinstance(iview, ISpinBoxView):
            return SpinBoxView[AnyFormItems]()
        elif isinstance(iview, IComboBoxView):
            return ComboBoxView[AnyFormItems]()
        elif isinstance(iview, IComboBoxItemsView):
            return ComboBoxItemsView[AnyFormItems]()
        elif isinstance(iview, ICheckBoxGroupView):
            return ButtonsGroupView[AnyFormItems](ButtonType.CHECKBOX)
        elif isinstance(iview, IRadioButtonGroupView):
            return ButtonsGroupView[AnyFormItems](ButtonType.RADIOBUTTON)
        return None


@dataclass(eq=False)
class ApplyFormView(FormView[AnyFormItems], IApplyFormView[AnyFormItems]):
    ...
    def _make_form(self, iview: IFormView[AnyFormItems]) -> "FormView[AnyFormItems]":
        ...
        if isinstance(iview, IApplyFormView):
            ...
            form_view_type: Type[ApplyFormView[AnyFormItems]] = make_dataclass(
                cls_name,
                fields=(),
                bases=(ApplyFormView[AnyFormItems], iview_type),
                eq=False,
            )
...
@dataclass(eq=False)
class GroupBoxFormView(FormView[AnyFormItems], IGroupBoxFormView[AnyFormItems]):
...
@dataclass(eq=False)
class GroupBoxApplyFormView(ApplyFormView[AnyFormItems], IGroupBoxApplyFormView[AnyFormItems]):
    view: QGroupBox = field(init=False, default_factory=QGroupBox)
