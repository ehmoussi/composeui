...
class ToolBar(View, IToolBar):
    ...
    @classmethod
    def from_itoolbar(cls, itoolbar: IToolBar) -> "ToolBar":
        ...
        toolbar_type: Type[ToolBar] = make_dataclass(
            cls_name, (), bases=(ToolBar, itoolbar_type), eq=False
        )
        return toolbar_type()


@dataclass(eq=False)
class CheckableToolBar(ToolBar, ICheckableToolBar):
    r"""Checkable Toolbar."""
