...
class QtVTKView(QtView, VTKView):
    ...
    _toolbar: QWidget = field(init=False, repr=False)
    _reset_camera_button: QPushButton = field(init=False, repr=False)
    _render_view: QVTKRenderWindowInteractor = field(init=False, repr=False)
    _renderer: vtkOpenGLRenderer = field(init=False, repr=False)
    _interactor: vtkRenderWindowInteractor = field(init=False, repr=False)
    _camera_orientation_manipulator: vtkCameraOrientationWidget = field(init=False, repr=False)
    _scalar_bar_lut: vtkLookupTable = field(init=False, repr=False)
    _scalar_bar: vtkScalarBarActor = field(init=False, repr=False)
    _scalar_bar_widget: vtkScalarBarWidget = field(init=False, repr=False)
    _vtk_warp_vector: Optional[vtkWarpVector] = field(init=False, repr=False, default=None)
    _actor: Optional[vtkActor] = field(init=False, repr=False, default=None)
