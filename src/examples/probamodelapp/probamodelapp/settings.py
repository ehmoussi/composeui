"""
Django settings for probamodelapp project.
...
SECRET_KEY = "django-insecure-1yjw+6auzhe0(p&z-6&v)n4+ffsk8vv35a#)z(p0#wdv#14$p@"
...
WSGI_APPLICATION = "probamodelapp.wsgi.application"
